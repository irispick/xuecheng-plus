...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        /*ProcessBuilder builder = new ProcessBuilder();
        builder.command("D:\\Program Files (x86)\\Tencent\\QQ\\Bin\\QQScLauncher.exe");
//将标准输入流和错误输入流合并，通过标准输入流程读取信息
        builder.redirectErrorStream(true);
        Process p = builder.start();
*/
        //ffmpeg的路径
        String ffmpeg_path = "E:\\tools\\apps\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\develop\\bigfile_test\\1先看这个JSP+SQL项目运行教程(华图录制仅供参考).avi";
        //转换后mp4文件的名称
        String mp4_name = "1先看这个JSP+SQL项目运行教程.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\develop\\bigfile_test\\1先看这个JSP+SQL项目运行教程.mp4";
        //创建工具类对象
