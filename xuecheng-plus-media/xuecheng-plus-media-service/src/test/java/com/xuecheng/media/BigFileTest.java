...
public class BigFileTest {
    ...
    public void testChunk() throws IOException {
        // 源文件
        File sourceFile = new File("D:\\develop\\bigfile_test\\IMG_9597.MP4");
        ...
        // 分块的大小
        int chunkSize = 1024 * 1024 * 1; // 1k * 1024 * 1 = 1M
    ...
    public void testMerge() throws IOException {
        ...
        // 合并后的文件
        File mergeFile = new File("D:\\develop\\bigfile_test\\IMG_9597_merge.MP4");
        ...
        Collections.sort(chunkFileList, new Comparator<File>() {
            @Override
            public int compare(File o1, File o2) {  //前减后升序，后减前降序
